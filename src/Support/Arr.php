...
class Arr
{
     ...
     * @return mixed
     */
    #[Pure] public static function get(array $array, string $key, mixed $default = null): mixed
    {
        if (is_null($key)) {
            return $array;
        }
     ...
     * @return bool
     */
    #[Pure] public static function has(array $array, array|string $keys): bool
    {
        if (is_null($keys)) {
            return false;
        }
